...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/functionality.js */ \"./src/modules/functionality.js\");\n\n\n\n// add new tasks//\n\nconst addIcon = document.getElementById('add-icon');\nconst taskInput = document.getElementById('taskInput');\nconst taskList = document.getElementById('taskList');\n\naddIcon.addEventListener('click', () => (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(taskInput, taskList));\n\ntaskInput.addEventListener('keypress', (e) => {\n  if (e.key === 'Enter') {\n    e.preventDefault(); // prevents page to reload when enter is pressed\n    (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__.addTask)(taskInput, taskList);\n  }\n});\n\n// Load tasks//\nwindow.addEventListener('load', () => {\n  (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__.loadTasks)();\n});\n\n// Delete task //\ntaskList.addEventListener('click', (e) => {\n  if (e.target.classList.contains('trash-icon')) {\n    const taskBox = e.target.parentElement;\n    const taskId = taskBox.dataset.id;\n    taskBox.remove();\n\n    (0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__.deleteTask)(taskId);\n  }\n});\n\n(0,_modules_functionality_js__WEBPACK_IMPORTED_MODULE_1__.updateTask)();\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
